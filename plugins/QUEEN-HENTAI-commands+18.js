...
if (!global.db.data.chats[m.chat].nsfw) throw `💝 Tika Hentai 💝 group doesnt supprt nsfw \n\n enable it by \n*${usedPrefix}enable* nsfw 💝 Tika Hentai 💝 join nsfw group https://chat.whatsapp.com/KranoAXweimE4CmvDcKnei`
